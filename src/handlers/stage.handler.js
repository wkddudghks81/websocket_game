...
export const moveStageHandler = (userId, payload) => {
  ...
  if(!currentStageInfo){
    return {stage:'fail',message:'Current stage info not found'}
  }
  ...
  const getUserItems = getUserItems(userId)
  const totalScore = calculateTotalScore(currentStage,serverTime,true,userItem)
